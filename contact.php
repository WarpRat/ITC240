...
{//if data, show it
    ...
    $myText = "<html><b><p>New contact from:</b></p>";
    $myText .= process_post();
    $myText .= "</html>";
	...
	echo '
		...
		<div id="content">
		        ...
		        <div class="content_item">
		          <h2>Contact Us</h2>
		          <p><b>Contact us with any questions:</b>
			      ...
			      <div style="width:430px; float:left;"><p><textarea class="contact textarea" rows="8" cols="50" name="Comments" placeholder="Please share any comments with us that you\'d like. If you have a question we\'ll get back to you within 48 hours. If this concerns an event coming up in the next 72 hours please call us instead. Thank you!"></textarea></p></div>
